...
function NavBar({ creatorMode }: { creatorMode: boolean }) {
  return (
    <nav style={{
      ...
      <span style={{ fontSize: '13px', letterSpacing: '0.15em', color: '#888' }}>SOON</span>
      {creatorMode ? (
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          <a href="https://soon-creator-network.vercel.app/creator-workspace" style={{ fontSize: '13px', color: '#1a1a1a', textDecoration: 'none', padding: '6px 14px', borderBottom: '1px solid #1a1a1a', letterSpacing: '0.03em' }}>
        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          ...
          <a href="https://soon-storyboard.vercel.app/storyboard" style={{ fontSize: '13px', color: '#888', textDecoration: 'none', padding: '6px 14px', letterSpacing: '0.03em' }}>
...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="zh-HK">
      <body style={{ margin: 0, padding: 0, paddingTop: '52px', backgroundColor: '#F5F2EC' }}>
